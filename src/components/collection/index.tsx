    ...
    <div className={"collection"}>
      <div className={"collection-header"}>
        <Tooltip placement="bottomLeft" title={"Create New"} mouseEnterDelay={0.5}>
          <Button className={"collection-header-create"} type="text" size="small"
            onClick={() => {
        ...
        <Input className={"collection-header-search"} size="small" placeholder="" prefix={<MenuOutlined />} onChange={onChange}/>
        <Tooltip placement="bottomLeft" title={"View more actions"} mouseEnterDelay={0.5}>
          <Button className={"collection-header-view"} type="text" size="small"><DashOutlined /></Button>
        </Tooltip >
      ...
      <Tree
        ...
        treeData={treeData}
        titleRender={(val) => <CollectionTitleRender updateDirectorytreeData={fetchDirectoryTreeData} val={val} treeData={treeData} currentWorkspaceId={currentWorkspaceId} />}
      />
