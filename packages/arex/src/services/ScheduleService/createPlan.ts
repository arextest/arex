...
export const MessageMap: {
  ...
  cn: {
    ...
    102: 'Error: Invalid or empty case source type.',
  ...
  en: {
    ...
    2: 'Error: The requested replay type is not supported, which may be caused by unmatched backend and frontend versions. Please try using another replay type or check the configuration of the backend services.',
