...
export const MessageMap: {
  ...
  cn: {
    ...
    104: '错误： 回放环境无法加载活动实例，请确认应用 Agent 已经启动且回放 Host 正确填写。',
  ...
  en: {
    ...
    104: 'Error: Unable to load active instance, make sure agent is attached and the format of target host is valid.',
